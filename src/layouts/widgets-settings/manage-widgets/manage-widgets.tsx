		...
		<WidgetSettingWrapper>
			{ui === 'SIMPLE' && (
				<div className="alert alert-warning rounded-2xl ring-4 ring-warning/10">
					Widgets cannot be managed in simple appearance mode.
				</div>
			)}
			<SectionPanel title="Choose widgets to show" size="sm">
				<div
			...
			label={
				<div className="flex items-center gap-2">
					...
					<div className="flex gap-0.5">
						...
						{isDisabled && (
							<span className="badge badge-error badge-xs">Disabled</span>
						)}
						{isSoon && (
