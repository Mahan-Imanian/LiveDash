...
const AuthForm = () => {
	...
	return (
		<div className="flex flex-col w-full max-w-xl px-2 mx-auto md:px-0">
			<div className="p-4 my-2 border shadow-md md:p-6 border-content bg-content rounded-xl md:rounded-2xl backdrop-blur-sm overflow-visible">
				{showPasswordForm ? (
					<AuthWithPassword />
				) : (
