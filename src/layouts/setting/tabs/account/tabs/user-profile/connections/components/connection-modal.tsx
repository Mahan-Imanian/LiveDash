			...
			<div className="p-4">
				<div className="flex items-center gap-3 mb-4">
					...
					<h2 className="text-xl font-semibold text-content">
						{platform.connected ? 'Disconnect Connect of' : 'Connection to'} {platform.name}
					</h2>
				</div>
					...
					{platform.connected ? (
						<div className="space-y-2">
							...
							<div className="p-3 text-sm rounded-2xl text-warning-content bg-warning/80">
								Disconnecting removes access to data and features related to this
								platform.
							</div>
						</div>
					) : (
				...
				<div className="flex justify-end gap-3">
					...
					>
						{platform.connected ? 'Disconnect Connect' : 'Confirm and connect'}
					</Button>
				</div>
			</div>
		</Modal>
