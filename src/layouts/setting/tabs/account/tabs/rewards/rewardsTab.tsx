						...
						<div className="flex items-start gap-3">
							...
							<div className="flex-1">
								<p className="mb-2 text-sm font-medium text-content">
									LiveCoin is the special LiveDash coin that you can
									collect and spend. 🎉
								</p>
								<p className="text-xs text-muted">
									By collecting LiveCoin, you can spend it on products
									and unlock special features inside LiveDash.
								</p>
							</div>
						</div>
					</div>
