...
export function ShortcutsTab() {
	...
	const shortcuts: Shortcut[] = [
		...
		},
		{
			...
			macKey: 'Middle-click',
			description: 'Open bookmark in a new tab with middle click',
			category: 'Bookmarks',
		},
		{
			...
			windowsKey: 'CTRL + Left-click',
			macKey: '⌘ + Left-click',
			description: 'Open all bookmarks in a folder',
			category: 'Bookmarks',
		},
		{
			id: 'toggle_theme',
	...
	return (
		<div className="w-full max-w-xl mx-auto" dir="ltr">
			<SectionPanel title="Shortcuts" delay={0.1}>
				<div className="space-y-5">
					<p className="text-muted">
						LiveDash shortcuts for faster use
					</p>
