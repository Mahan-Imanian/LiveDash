...
const predefinedGradients: { from: string; to: string; name: string }[] = [
	{ from: '#ff9a9e', to: '#fad0c4', name: 'Soft pink' },
	{ from: '#a1c4fd', to: '#c2e9fb', name: 'Sky blue' },
	{ from: '#d4fc79', to: '#96e6a1', name: 'Spring green' },
	{ from: '#ffecd2', to: '#fcb69f', name: 'Autumn orange' },
	{ from: '#84fab0', to: '#8fd3f4', name: 'Turquoise' },
	{ from: '#cfd9df', to: '#e2ebf0', name: 'Light gray' },
	{ from: '#a6c0fe', to: '#f68084', name: 'Blue to pink' },
	{ from: '#fbc2eb', to: '#a6c1ee', name: 'Soft purple' },
]
...
export function GradientWallpaper({
	...
	return (
		<div className="space-y-4">
			<SectionPanel title="Default gradients">
