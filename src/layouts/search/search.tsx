				...
				<form onSubmit={handleSubmit}>
					...
					>
						...
						<input
							...
							className={
								'w-full py-1.5 text-base  font-light text-left focus:outline-none text-content placeholder:text-base-content/60 placeholder:font-medium focus:placeholder:opacity-50 bg-transparent'
							}
