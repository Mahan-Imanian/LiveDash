...
export function BookmarkPopover({ isOpen, onClose, coords }: BookmarkPopoverProps) {
	...
	const c =
		fetchedBookmarks.find((b) => b.id === currentFolderId)?.title || 'My bookmarks'
		...
		>
			{!browserBookmarksEnabled ? (
				<div className="p-5 text-center">
					...
					<p className="mb-1 text-sm font-bold">Bookmarks access</p>
					<p className="mb-4 text-xs leading-relaxed text-muted">
						To show browser bookmarks here, LiveDash needs your permission.
