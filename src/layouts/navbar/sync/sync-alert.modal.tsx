...
> = {
	BOOKMARKS: {
		title: 'Bookmark sync',
		message:
			'Some of your bookmarks were not synced. Try syncing again.',
	},
	TODOS: {
		title: 'Sync tasks',
		message:
			'Some of your tasks were not synced. Try syncing again.',
	},
}
					...
					<div className="flex items-start gap-3 p-3 mt-3 border rounded-2xl bg-warning/10 border-warning/20">
						...
						<div className="min-w-0">
							<div className="text-sm font-semibold text-warning">
								The bookmark icon may not be saved.
							</div>
							<p className="mt-1 text-xs leading-relaxed text-warning/90">
								Custom bookmark icons may need to be
								set again after sync.
							</p>
						</div>
					</div>
				)}
