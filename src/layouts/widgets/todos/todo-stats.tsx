...
export function TodoStats() {
	...
	return (
		<div className={'p-2 mt-2  rounded-lg'}>
			<h4 className={'mb-1 text-sm font-medium text-content'}>Overview</h4>

			<div className="flex flex-col gap-1">
				<div className={'p-1 rounded-lg border border-content'}>
					<span className={'text-xs text-content'}>Completed</span>
				...
				<div className={'p-2 rounded-lg  border border-content'}>
					<span className={'text-xs text-content'}>Priorities</span>
					<div className="flex justify-between mt-1">
						<div className="text-center">
							...
							<span className={'text-xs text-content'}>High priority</span>
						</div>
						<div className="text-center">
							<div className="flex items-end h-8">
								<div
						...
						<div className="text-center">
							...
							<span className={'text-xs text-content'}>Low</span>
						</div>
					</div>
				</div>
			</div>
