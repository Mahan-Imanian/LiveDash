...
export function EditTodoModal({ todo, isOpen, onClose }: EditTodoModalProps) {
	...
	const handleDateSelect = useCallback((date: moment.Moment) => {
			...
			<div className="p-1 space-y-2">
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-3">
						...
						<button
							...
							className="min-w-full text-left px-2 py-1.5 min-h-8 text-xs rounded-xl border border-base-300 hover:border-primary/50 transition-colors bg-content text-content opacity-75 cursor-pointer"
						>
							{selectedDate
								? selectedDate.locale('en').format('dddd, D MMMM')
								: 'Select date'}
						</button>
						<ClickableTooltip
				...
				<div className="flex items-center gap-3">
					...
					<TextInput
						...
						placeholder="Category (example: Personal, Work)"
				...
				<div className="flex items-center gap-2">
					...
					<textarea
						...
						placeholder="Note or link (optional)"
