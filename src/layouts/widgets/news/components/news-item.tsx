...
export const NewsItem = ({
	...
	const formatDate = (dateString: string) => {
		try {
			...
			return moment(date).locale('en').format('HH:mm - YYYY/MM/DD')
		} catch {
			return dateString
		}
	}
	...
	return (
		<div className="transition-all">
			<div
				className={`p-2 transition-all duration-300 border rounded-2xl cursor-pointer bg-base-300/70 hover:bg-base-300/20 hover:scale-95 border-base-300/70 active:scale-98`}
				onClick={handleClick}
			>
				{image_url && (
					<img
