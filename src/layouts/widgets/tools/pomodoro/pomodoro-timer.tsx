	...
	const handleTimerComplete = () => {
		...
		if (Notification.permission === 'granted') {
			...
			const textList: Record<TimerMode, string> = {
				work: 'Work timer finished. Time for a short break.',
				'short-break': 'Short break finished. Ready to continue working?',
			}
				...
				<div className={`flex items-center gap-x-0.5`}>
					{currentTab === 'timer' ? (
						...
						<SelectBox
							value={topUsersType}
							options={[
								{ label: 'All-time board', value: TopUsersType.ALL_TIME },
								{ label: 'Weekly board', value: TopUsersType.WEEKLY },
								{ label: 'Daily leaderboard', value: TopUsersType.DAILY },
							]}
