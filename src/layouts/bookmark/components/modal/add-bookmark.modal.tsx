...
export function AddBookmarkModal({
	...
	return (
		<Modal
			...
			size="md"
			title={`${type === 'FOLDER' ? 'Folder New' : 'New bookmark'}`}
			direction="ltr"
				...
				<div className="mt-1 overflow-hidden">
					...
					<div className="py-2 overflow-auto">
						...
						<TextInput
							...
							className={
								'mt-2 w-full px-4 py-3 text-left rounded-lg transition-all duration-200 '
							}
						/>
						<div className="relative h-[50px]">
							{type === 'BOOKMARK' && (
								<TextInput
									...
									className={
										'mt-2 w-full px-4 py-3 text-left absolute rounded-lg transition-all duration-300'
									}
								/>
							)}
						</div>
