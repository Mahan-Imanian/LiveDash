...
export function BookmarkGrid({
	...
	const handleDeleteBookmark = (bookmark: Bookmark) => {
		if (!isAuthenticated) {
			return showToast('Sign in to delete bookmarks.', 'error')
		}
		...
		>
			...
			{showEditBookmarkModal && bookmarkToEdit && !isAuthenticated ? (
				<AuthRequiredModal
					...
					message="Sign in to edit bookmarks."
			...
			<ConfirmationModal
				...
				message={
					bookmarkToDelete?.type === 'FOLDER' ? (
						<div>
							<p>
								Are you sure you want to delete folder "{bookmarkToDelete.title}" ?
							</p>
						...
						<p>
							Are you sure you want to delete bookmark "{bookmarkToDelete?.title}" ?
						</p>
					)
				}
