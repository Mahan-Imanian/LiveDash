...
export function Dropdown({
	...
	useEffect(() => {
		...
		// Initial calculation with a short delay
		...
		// ResizeObserver tracks size changes
		const resizeObserver = new ResizeObserver(() => {
			// Use requestAnimationFrame only for this callback
			// Keep it smooth without a loop
			requestAnimationFrame(calculatePosition)
		})

		// Track trigger and all parents
