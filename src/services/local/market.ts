...
export const localMarketItems: MarketResponse = {
	totalPages: 1,
	items: [
		{ id: 'theme-glass', name: 'Glass Command', description: 'Premium glass panels, crisp borders, and high-readability dashboard depth.', type: 'THEME', price: 0, meta: { accent: 'Cyan' }, previewUrl: null, itemValue: Theme.Glass, isOwned: true },
		{ id: 'theme-icy', name: 'Nordic Blue', description: 'Cool blue surfaces tuned for bright workspaces and daylight wallpapers.', type: 'THEME', price: 0, meta: { accent: 'Blue' }, previewUrl: null, itemValue: Theme.Icy, isOwned: true },
		{ id: 'theme-dark', name: 'Midnight Core', description: 'A serious low-light setup with stronger contrast and calmer glow.', type: 'THEME', price: 0, meta: { accent: 'Indigo' }, previewUrl: null, itemValue: Theme.Dark, isOwned: true },
		{ id: 'theme-light', name: 'Daylight Pro', description: 'A clean light interface with strong legibility and minimal visual noise.', type: 'THEME', price: 0, meta: { accent: 'Sky' }, previewUrl: null, itemValue: Theme.Light, isOwned: true },
		{ id: 'theme-amethyst', name: 'Amethyst Desk', description: 'Violet highlight system for creative and studio-focused dashboard layouts.', type: 'THEME', price: 0, meta: { accent: 'Violet' }, previewUrl: null, itemValue: Theme.Glass, isOwned: true },
		{ id: 'theme-graphite', name: 'Graphite OS', description: 'Neutral graphite chrome with subtle glass layers and controlled contrast.', type: 'THEME', price: 0, meta: { accent: 'Slate' }, previewUrl: null, itemValue: Theme.Dark, isOwned: true },
