(function () {
  const STORE_KEY = 'livedash_state_v21';
  const LEGACY_KEYS = ['livedash_state_v20', 'livedash_state_v18', 'livedash_state_v121', 'livedash_state_v12', 'livedash_state_v11', 'livedash_state_v10', 'livedash_state_v9'];
